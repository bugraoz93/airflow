...
from airflow.providers.keycloak.auth_manager.services.token import KeycloakAuthManagerToken
...
def create_token(body: TokenBody) -> TokenResponse:
    return KeycloakAuthManagerToken.create_token(body=body, token_type="API")
...
def create_token_cli(body: TokenBody) -> TokenResponse:
    return KeycloakAuthManagerToken.create_token(body=body, token_type="CTL")
